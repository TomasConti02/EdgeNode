...
The real CV model have to be something like a RestNet   -> ctivation of 224 x 224 nd output emedding of 512 with the respective classification
"""
...
model.fit( x_train, { "probabilities": y_train, "embedding": dummy_embedding, "predicted_class": dummy_predicted_class, }, epochs=1, )
# SUPER IMPORTANT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
